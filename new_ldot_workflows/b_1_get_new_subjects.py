...
def get_new_subjects(
    ldot_client,
    study_id: str,
    eaid_qualtrics_survey_link_creation_to_do_date: str,
    eaid_qualtrics_survey_link_completed: str,
) -> list:
    ...
    try:
        ...
        raise ValueError(
            "Ldot lookup to find subjects with link creation to do date returned invalid JSON",
            response,
        ) from e
    ...
    try:
        ...
        raise ValueError(
            "Ldot lookup to find subjects with link creation completed returned invalid JSON",
            response,
        ) from e
...
if __name__ == "__main__":
    ...
    print(
        get_new_subjects(
            "5c9c6a47-c8d7-8142-a8c8-ccdcb8a8044b",
            "5d31129c-d814-5d4b-a96f-048cadc150ce",
            "31599192-8e9b-4341-b7f4-8b8967dd846a",
        )
    )
