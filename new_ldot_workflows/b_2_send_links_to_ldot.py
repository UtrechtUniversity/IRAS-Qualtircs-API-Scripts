...
def send_links_to_ldot(
    ldot_client,
    ldot_study_id: str,
    id_deelnemer_entity: str,
    id_location: str,
    custom_var_qualtrics_link: str,
    link_completed_eaid: str,
    subject_id_to_link_dict: dict,
) -> list:
...
if __name__ == "__main__":
    ...
    subject_id_to_link_dict = {
        "a92ff326-ba91-46ed-9cfc-cfcdb71f2817": "https://survey.uu.nl/jfe/form/SV_efCMOg6wHU0T8ii?Q_CHL=gl&Q_DL=EMD_7AEa416lRwFhrkF_efCMOg6wHU0T8ii_CGC_9bNzmVXkZpdfEQ9&_g_=g"
    }
