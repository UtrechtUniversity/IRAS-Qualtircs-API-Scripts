...
def send_progress_to_ldot(ldot_client, ldot_study_id: str, eaid_survey_progress_completed: str, participant_to_progress_dict: dict) -> list:
...
if __name__ == "__main__":
    ...
    send_progress_to_ldot(ldot_client, ldot_study_id, eaid_survey_progress_completed, participant_to_progress_dict)